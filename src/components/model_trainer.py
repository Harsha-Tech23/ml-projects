    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            if best_model_score < 0.6:
                raise CustomException("No suitable model found with test R² >= 0.6")

            logging.info(f"Best model: {best_model_name} with Test R²: {best_model_score:.4f}")
            ...
            # Predict and return R² on test data
